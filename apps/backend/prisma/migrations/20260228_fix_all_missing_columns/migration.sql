...
CREATE TABLE IF NOT EXISTS "conversations" (
    ...
    "contactAvatar" TEXT,
    "lastMessage" TEXT,
    "lastMessageAt" TIMESTAMP(3) DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS "workflow_executions" (
    ...
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW(),
    "expiresAt" TIMESTAMP(3) NOT NULL DEFAULT NOW(),
    "completedAt" TIMESTAMP(3) DEFAULT NOW(),
    "error" TEXT,
...
CREATE TABLE IF NOT EXISTS "users" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW(),
    "licenseExpiresAt" TIMESTAMP(3) DEFAULT NOW(),
    "licenseStatus" "LicenseStatus" NOT NULL DEFAULT 'TRIAL',
    "trialEndsAt" TIMESTAMP(3) DEFAULT NOW(),
...
ALTER TABLE "conversations" ADD COLUMN IF NOT EXISTS "lastMessageAt" TIMESTAMP(3) DEFAULT NOW();
...
ALTER TABLE "conversations" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "messages" ADD COLUMN IF NOT EXISTS "timestamp" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "messages" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "contact_flow_states" ADD COLUMN IF NOT EXISTS "expiresAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
ALTER TABLE "contact_flow_states" ADD COLUMN IF NOT EXISTS "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE "contact_flow_states" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "workflows" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "workflow_executions" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
ALTER TABLE "workflow_executions" ADD COLUMN IF NOT EXISTS "expiresAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
ALTER TABLE "workflow_executions" ADD COLUMN IF NOT EXISTS "completedAt" TIMESTAMP(3) DEFAULT NOW();
...
ALTER TABLE "whatsapp_sessions" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "whatsapp_labels" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "whatsapp_group_configs" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "whatsapp_chat_labels" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "whatsapp_auth_states" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "licenseExpiresAt" TIMESTAMP(3) DEFAULT NOW();
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "licenseStatus" "LicenseStatus" NOT NULL DEFAULT 'TRIAL';
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "trialEndsAt" TIMESTAMP(3) DEFAULT NOW();
...
ALTER TABLE "tenants" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "tags" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "shareable_workflows" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "global_configs" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "execution_logs" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
...
ALTER TABLE "contact_tags" ADD COLUMN IF NOT EXISTS "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT NOW();
